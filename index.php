...
<div class="main_div">
     ...
     <div class="navbar navbar-expand-md">
      ...
      <a href="#" class="navbar-brand font-weight-bold text-white text-center"><h2>MONEY MONEY BANK</h2></a>
     ...
     <div class="container">
        <div class="row">
          <div class="col-sm-6">
            <h1 class="main_text">MONEY MONEY BANK</h1>
  ...
  <section class="contactus" id="contact" >
       ...
       <footer><center>&#169; 2021 THE SPARKS FOUNDATION | DESIGNED BY GITESH YELAVE</center></footer>
</body>
</html>